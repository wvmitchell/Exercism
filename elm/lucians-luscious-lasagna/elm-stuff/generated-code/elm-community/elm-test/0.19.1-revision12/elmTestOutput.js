...
var $author$project$LuciansLusciousLasagna$preparationTimeInMinutes = function (layers) {
	return layers * 2;
};
var $author$project$LuciansLusciousLasagna$elapsedTimeInMinutes = F2(
	function (layers, timeInOven) {
		return $author$project$LuciansLusciousLasagna$preparationTimeInMinutes(layers) + timeInOven;
	});
...
var pipeFilename = "/tmp/elm_test-2338.sock";
var net = require('net'),
