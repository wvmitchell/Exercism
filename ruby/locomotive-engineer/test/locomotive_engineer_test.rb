...
class LocomotiveEngineerTest < Minitest::Test
  def test_get_array_of_wagons_with_a_few_inputs
    assert_equal [1, 5, 2, 7, 4],
                 LocomotiveEngineer.generate_list_of_wagons(1, 5, 2, 7, 4)
  end
  ...
  def test_get_array_of_wagons_with_many_inputs
    assert_equal [1, 10, 6, 3, 9, 8, 4, 14, 24, 7],
                 LocomotiveEngineer.generate_list_of_wagons(
                   1,
                   10,
                   6,
                   3,
  ...
  def test_fix_array_of_wagons_a_few_inputs
    assert_equal [1, 3, 17, 6, 15, 7, 4, 12, 6, 3, 13, 2, 5],
                 LocomotiveEngineer.fix_list_of_wagons(
                   [2, 5, 1, 7, 4, 12, 6, 3, 13],
                   [3, 17, 6, 15]
                 )
  end
