...
describe('push to a list', () => {
  ...
  it('can push to a 1 element list', () => {
    const list = List.create()
    list.push(1)
    list.push(2)
    expect(list.head).not.toBeNull()
  ...
  it('can push to a multi-element list', () => {
    const list = List.create()
    list.push(1)
    list.push(2)
    list.push(3)
...
describe('unshift', () => {
  it('can unshift to an empty list', () => {
    const list = List.create()
    list.unshift(1)
    expect(list.head).not.toBeNull()
    expect(list.tail).not.toBeNull()
  ...
  it('can unshift to a 1 element list', () => {
    const list = List.create()
    list.unshift(1)
    list.unshift(2)
    expect(list.head).not.toBeNull()
  ...
  it('can unshift to a multi-element list', () => {
    const list = List.create()
    list.push(1)
    list.push(2)
    list.push(3)
